...
authornote: |
  ...
  Materials for all experiments can be found at https://osf.io/znq3y/. Preregistration information for Experiments can be found at https://osf.io/c4w8s/ (Exp. 1), https://osf.io/czkdh/ (Exp. 2), and https://osf.io/5ewa6 (Exp. 3). 

abstract: |
  Numerous psychological findings have shown that mere exposure to ideas makes those ideas seem more true, a finding commonly referred to as the “illusory truth” effect [e.g. @hasher.etal1977]. In the presence of pervasive misinformation, this basic feature of cognition may undermine the functioning of a democratic society [@pennycook.etal2018]. However, genuine beliefs do not only affect judgments about individual statements, they also imply other beliefs and drive decision-making. Here, we sought to examine whether mere exposure to statements produces genuine beliefs by examining whether people draw inferences from statements after mere exposure. Surprisingly, and in contrast to fluency or familiarity-based accounts of the illusory truth effect [e.g. @dechene.etal2010], we found that exposure to “premise” statements affected participants’ truth ratings for novel “implied” statements. This “illusory implication” effect suggests that the consequences of exposure to false statements reach further than previously thought and calls for a new mechanistic account of these effects.
...
Three pre-registered experiments examined whether mere exposure to ideas might lead them to be adopted as beliefs. It is well-established that mere exposure, such as in a true-or-false quiz, can lead people to later rate statements as more true (the “illusory truth” effect). If people's beliefs are affected by mere exposure, then the pervasiveness of misinformation would be even more harmful than currently recognized. However, leading theories attribute illusory truth effects to feelings of familiarity or fluency rather than changes in beliefs. These metacognitive heuristics are unlikely to produce further inferences or drive decision-making, as would beliefs. In contrast, we demonstrate that mere exposure to statements affected participants' responses to other novel statements (what we term an “illusory implication” effect), suggesting that mere exposure can lead to genuine belief. Our findings illustrate new dangers in exposure to misinformation, showing that mere exposure may have more wide-ranging influences than previously understood.
...
A handful of studies are suggestive in this regard: Arkes and collagues [-@arkes.etal1991] found that mere exposure to one set of statements also affected judgments about novel related statements on the same topic (China). However, these findings could also be explained by a sense of familiary engendered by the shared topic of old and new statements [@arkes.etal1991]. 
...
All item pairs were identical to Experiment 2. However, several changes were made to the study's procedures limit the potential that the illusory implication effect could be produced by idiosyncratic features of the experimental task.
...
To improve our ability to measure the implication effect, in Experiment 3 participants were exposed to 12 of the premise statements at exposure rather than eight. As a consequence, we did not examine illusory truth effects. The 24 premise statements were randomly sorted in to 12 comparison questions, and each participant saw 6 of these pairs at exposure, along with five control pairs. 

Following the test phase, two new questions assessed the potential influence of task demands. Participants were asked if they ever suspected the study had an undisclosed purpose (yes/no), and then regardless of their answer asked to explained their suspicions in an open-ended response. Responses were coded to identify participants who guessed that the true purpose concerned how their responses to the test phase would be affected by the exposure phase or by seeing misinformation. These participants were excluded from certain analyses following our pre-registered analysis plan.
...
```{r fig-exp3, fig.align='center', fig.cap="Average truth ratings for Implication statements in Experiment 3, broken down by exposure (exposed vs. unexposed) and implication type (true-implied-false vs false-implied-true). For visualization purposes, means were calcaulated by translating ordinal responses onto a scale from -2.5 to 2.5. Error bars indicate standard errors."}
...
Next, to explore the possibility that these results might be influenced by task demands, we also carried out a parallel analysis excluding participants whose responses may have been impacted by their suspicions as to the true purpose of the study. We excluded both participants who explicitly stated they were suspicious when asked directly, and those who forced to guess in an open-ended response, guessed that the true purpose had to do with the first phase somehow affecting their responses in the second. Removing these participants did not substantially change the estimate of the implication effect (stats).
