...
abstract: |
  Numerous psychological findings have shown that mere exposure to ideas makes those ideas seem more true, a finding commonly referred to as the “illusory truth” effect.  Under predominant accounts of the illusory truth effect, initial exposure to a statement provides a metacognitive feeling of “fluency” or familiarity that, upon subsequent exposure, leads people to infer the statement is more likely to be true. However, genuine beliefs do not only affect truth judgments about individual statements, they also imply other beliefs and drive decision-making. Here, we consider whether exposure to “premise” statements affects people's truth ratings for novel “implied” statements, a pattern of findings a pattern of findings we call the "illusory implication" effect. We argue these effects would constitute evidence for genuine belief change from mere exposure and  identify a handful of existing findings that offer preliminary support for this claim. Building upon these, we conduct three new pre-registered experiments to further test this hypothesis, finding additional evidence that exposure to “premise” statements affected participants’ truth ratings for novel “implied” statements, including for considerably more distant implications than those previously explored. Our findings suggest that the effects of mere exposure reach further than previously thought, with potentially consequential implications for concerns around mis- and disinformation.
...
The extent to which the illusory truth effect operates entirely through metacognitive processes stands to determine the extent of its real-world consequences. Generally, it is the wider consequences of belief (beyond truth ratings for a specific proposition) that should be most concerning. If illusory truth effects operate only through metacognitive influences, then the impact of prior exposure depends on a subsequent re-exposure to a now fluent or familiar situation or statement (which might include one activating similar concepts). To be sure, this might have important consequences, such as increasing the tendency to share information online after having been exposed previously [@vellani.etal2023]. Still, the impact of metacognitive effects seem less likely to drive inferences or decision-making in more novel situations. Instead, their influences would be constrained to operating within contexts similar to the initial exposure.

## Is there an "Illusory Implication" Effect?

A crucial feature of belief is that beliefs are connected with other related beliefs. Thus, one way to test whether mere exposure affects beliefs is to examine whether mere exposure to statements can affect truth ratings for other related or implied statements. We refer to this hypothetical impact of mere exposure on implied statements as the "Illusory Implication" Effect.

We believe a number of existing findings provide at least preliminary evidence for this illusory implication effect. A number of researchers have found that mere exposure affects truth ratings for paraphrases and direct implications or contradictions [@arkes.etal1991; @bacon1979; @garcia-marques.etal2015; @silva.etal2017; @unkelbach.rom2017]. A crucial question is how distantly inferences are drawn following mere exposure, and whether or not metacognitive accounts can explain these findings.

Silva and colleagues [-@silva.etal2017] found that mere exposure to statements increased truth ratings for paraphrases of those statements that expressed the same idea while sharing only minimal surface-level linguistic features. Conversely, exposure to statements *decreased* truth ratings for rephrased contradictions of those statements. Silva and colleagues [-@silva.etal2017] explain their findings as resulting from conceptual fluency and disfluency produced by the initial mere exposure to statements: prior exposure "activates" the relevant concepts, easing or interfering with their retrieval and use in processing subsequent statements and thereby producing different metacognitive experiences.

However, findings from Unkelbach and Rom [-@unkelbach.rom2017] cast doubt on a purely fluency-based account of these types of findings. These researchers also found that exposure to statements decreased truth judgments for contradictions of those statements. Crucially however, they also found that responses were faster for contradictions of previously-seen statements than for novel statements, indicating that processing of these statements was *more* rather than less fluent. Thus "conceptual disfluency" is not likely to be an appropriate account of these findings [@unkelbach.rom2017]. Instead, they and other authors theorize that people tend to believe statements so long as they are generally coherent with respect to existing knowledge, even if they are presented in a context of mere exposure [@garcia-marques.etal2015; @gilbert1991; @unkelbach.rom2017].

## The present studies

Prior work tested the effect of mere exposure on implied statements using only direct contradictions of the original statement (or paraphrases of direct contradictions). Here, we sought to further test for an "illusory implication effect" by testing the effect of mere exposure to statements on their more distant logical implications. To do so, we designed a series of studies to examine whether mere exposure to one statement (the “premise”) could affect truth ratings for another statement this premise would logically entail to be either true or false (the “implication”). 

We developed materials involving more distant inferences that do not afford direct one-to-one mappings between shared concepts in the premise and implication statements. Thus, any reduction in truth ratings for the contradicted statements following exposure to the premise statements are not likely to be attributable to disfluency [cf. @silva.etal2017]. For instance, one statement pair was the premise statement, “No U.S. astronauts have died since the Challenger explosion in 1986” paired with the implied statement, “The space shuttle Columbia disintegrated over Texas in 2003” (true, but contradicted by the "premise"). In contrast with prior work examining conflicting statements, there is no direct one-to-one mapping of concepts between the two statements. Instead, a chain of inferences must developed for a conclusion to be drawn: that the space shuttle Columbia contained astronauts, that its disintegration would have killed them, and that 2003 is later than 1986. 

In addition, we make several additional contributions toward definitively demonstrating the illusory implication effect beyond existing studies by 1) testing the effect with large samples of participants (present studies $N = 1020$), 2) utilizing modern hierarchical statistical modeling methods, and 3) taking great pains to ensure that participants' truth ratings are not influenced by task demands (Experiments 2 and 3). Across our studies, we find further compelling evidence for this “illusory implication” effect, indicating that mere exposure has genuine impacts on beliefs extending beyond those attributable to metacognitive cues.
...
We tested for the illusory truth effect by comparing truth ratings for premise statements seen during exposure to those that had not been seen. Similarly, we tested for the illusory implication effect by comparing truth ratings for implication statements whose corresponding premise statements were and were not presented during the exposure phase. If mere exposure to "premise" statements affects participants' judgments of the "implication" statements, this would be evidence for an illusory implication effect.
...
Figure 1 shows participants’ average truth ratings for the implication statements in the quiz condition. Participants gave higher truth ratings following exposure for entailed statements, and somewhat lower truth ratings following exposure for contradicted statements. 
...
A regression model was used to tease apart the possible metacognitive effects of mere exposure of and logical implication. The model includes a) a binary variable indicating the type of implication statement's actual truth value (true or false), b) a binary predictor for prior exposure to the related premise coded zero when the premise was not seen and 1 when it was seen (capturing potential uni-directional metacognitive effects of exposure), c) and a variable capturing the effect of implications, coded 1 for implied truth, -1 for implied falsehood, and zero when the related premise statement was not seen at exposure. Thus the "implication" predictor accounts for the effect of exposure to the premise on truth judgments for the implied statements (either positive or negative), while the "exposure" predictor accounts for any positive effect from metacognitive cues. We also incorporated "maximal" random intercepts and slopes for all terms varying by subject and item [@barr.etal2013]. Expressed in the common “lme4” syntax [@bates.etal2015], the regression model was:
...
df2_plotting <- df2 %>% 
  ...
  mutate(B_implied_true = if_else(B_implied_true == "T implied F", "Contradicted", "Entailed") )
...
In Experiments 1 and 2, the effect of exposure was weaker than the measured implication effect, so that average truth ratings were higher after exposure for entailed items and lower for contradicted items (Figures 1 and 2). In Experiment 3 however, the estimated effect of exposure and implication were similar, and truth ratings were similar for exposed and unexposed contradicted items (Figure 3). Although the estimate for the implication effect in our statistical model was clearly greater than zero, this may nevertheless allow a possible alternate explanation of our findings: that the contradicted items' premise statements simply do not engender as much familiarity or fluency for their implications as do the entailed items, so that the effects differ between these groups. Put another way, the identification of the "implication" effect coefficient rests on the assumption that familiarity and fluency effects are not accidentally confounded with item groups. 
