...
Generally, it is these wider consequences of belief (beyond truth ratings for a specific proposition) that should be most concerning. If illusory truth effects operate only through metacognitive influences, then these effects may not have much impact outside the lab.  Under these theoretical accounts, the impact of prior exposure depends on a subsequent re-exposure to a now fluent or familiar statement. This would make the real-world consequences of the illusory truth effect far narrower than one might otherwise fear: These metacognitive mechanisms are liable to apply only in response to the exact statements previously seen, but are not as likely to generalize to other related ideas, or to drive actions or decision-making in novel contexts. 
...
A crucial feature of belief is that beliefs are connected with other related beliefs. Thus, one way to test whether mere exposure affects beliefs is to examine whether mere exposure to statements can affect truth ratings for other related statements. We refer to this hypothetical impact of mere exposure on implied statements as the "Illusory Implication" Effect.

A handful of studies are suggestive in this regard: Unkelbach and Rom [-@unkelbach.rom2017] found that mere exposure to one statement could increase endorsements of implied statements. For instance, people were more likely to endorse the statement "Most accidents occur close to weekends" after exposure to the statement "Most accidents occur on Mondays". Similarly, Arkes and colleagues [-@arkes.etal1991] found that mere exposure to one set of statements also affected judgments about novel related statements on the same topic (China). However, in both cases these findings can also be easily explained by fluency or familiarity engendered by the similarity between the presented and tested statements [@arkes.etal1991; @unkelbach.rom2017]. 

A case where mere exposure lead to a lower truth rating for a related statement (i.e., one implied to be false) would more clearly implicate an effect of mere exposure on beliefs. In our review of the literature, we find three reported studies that offer preliminary evidence of this effect: Bacon [-@bacon1979] found that mere exposure to one statement ($P$) could lead to lower truth ratings for a new, contradictory statements($\neg P$) after a three-week delay. For instance, mere exposure to "crocodiles sleep with their eyes open" produced lower truth ratings for "crocodiles sleep with their eyes closed". Findings from an experiment by Garcia-Marques and colleagues [-@garcia-marques.etal2015] partially contradicted these results (using a slightly different exposure task), finding lower truth ratings for contradictory statements when participants were queried immediately, but finding the opposite pattern of results at the delay used by the original Bacon [-@bacon1979] study. A later series of experiments by Unkelbach and Rom [-@unkelbach.rom2017] generally replicated the newer findings [@garcia-marques.etal2015], although the effects were not observed consistently in each experiment.

## The present studies

Here, we sought to expand upon prior experiments to decisively examine whether mere exposure to statements could influence people's beliefs by testing for an "illusory implication" effect. To do so, we examined whether people draw inferences from statements after exposure in a context without any presupposition of truth. We designed a series of studies to examine whether mere exposure to one statement (the “premise”) could affect truth ratings for a  different statement the premise would logically entail (the “implication”). Crucially, we test this across cases where premises entail either the truth or falsehood of another related statement, ruling out purely metacognitive explanations. 

In addition, we make several additional contributions toward definitively demonstrating the illusory implication effect beyond existing studies by 1) developing a new set of materials, 2) recruiting larger samples (present studies $N = 1020$, total prior cited studies $N = 452$), 3) utilizing modern hierarchical statistical modeling methods, and 4) taking great pains to ensure that participants' truth ratings are not influenced by task demands (Experiments 2 and 3). Across our studies, we find new compelling evidence for this “illusory implication” effect, indicating that mere exposure has genuine impacts on beliefs extending beyond those attributable to metacognitive cues.
